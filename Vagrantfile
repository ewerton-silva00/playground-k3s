...
servers = {
  'k3s-master' => { 'ip' => '10.10.10.10', 'memory' => '2048', 'cpus' => '2', 'disk' => '/tmp/tpxBQAzZif8c4berq75K.vdi' }
}
  ...
  servers.each do |name, conf|
    config.vm.define "#{name}" do |cfg|
      ...
      cfg.vm.provision "shell", inline: <<-SHELL
        ...
        sudo mount --types ext4 /dev/sdb1 /mnt/docker
        sudo su -c "echo '/dev/sdb1 /mnt/docker ext4 defaults 0 0' >> /etc/fstab"
        hostnamectl
      SHELL
    end
  end
